...
namespace al
{
	...
	export inline auto get_display_dimensions(const ALLEGRO::DISPLAY& display) -> const ALLEGRO::SIZE<int32_t>
	{
	...
	{
		return ALLEGRO::DISPLAY(::al_create_display((int32_t)size.width, (int32_t)size.height), internal::destroy_display);
	}
