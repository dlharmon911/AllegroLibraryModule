...
namespace ALLEGRO
{
	...
	export enum
	{
		BITMAP_LOCK_READWRITE = ALLEGRO_LOCK_READWRITE,
		BITMAP_LOCK_READONLY = ALLEGRO_LOCK_READONLY,
		BITMAP_LOCK_WRITEONLY = ALLEGRO_LOCK_WRITEONLY
	};
}

namespace al
{
	export inline ALLEGRO::BITMAP_LOCKED_REGION lock_bitmap(ALLEGRO::BITMAP& bitmap, int32_t format, int32_t flags)
	{
	...
	export inline ALLEGRO::BITMAP_LOCKED_REGION lock_bitmap_region(ALLEGRO::BITMAP& bitmap, const ALLEGRO::RECTANGLE<int32_t> region, int32_t format, int32_t flags)
	{
	...
	export inline ALLEGRO::BITMAP_LOCKED_REGION lock_bitmap_blocked(ALLEGRO::BITMAP& bitmap, int32_t flags)
	{
	...
	export inline ALLEGRO::BITMAP_LOCKED_REGION lock_bitmap_region_blocked(ALLEGRO::BITMAP& bitmap, const ALLEGRO::RECTANGLE<int32_t> region, int32_t flags)
	{
	...
	export inline void unlock_bitmap(ALLEGRO::BITMAP& bitmap)
	{
		al_unlock_bitmap(bitmap.get());
	}

	export inline bool is_bitmap_locked(ALLEGRO::BITMAP& bitmap)
	{
